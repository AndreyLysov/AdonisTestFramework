...
#    And "<Employee>" has current onboard activity on "<Vessel>" vessel started 20 days ago on "<Position>" position
...
#
#  Examples:
#  |Vessel|Position|Employee|
#  |Black Pearl|Seaman|Bart Simpson|
